(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("apptemplate", [], factory);
	else if(typeof exports === 'object')
		exports["apptemplate"] = factory();
	else
		root["apptemplate"] = root["apptemplate"] || {}, root["apptemplate"]["AppItemDetailsPage"] = factory();
})(this, () => {
return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({

/***/ "./frontend/components/AppItemDetailsPage.ts":
/*!***************************************************!*\
  !*** ./frontend/components/AppItemDetailsPage.ts ***!
  \***************************************************/
...
class AppItemDetailsPage {
    constructor() {
        ...
        this.currentAppItemId = null;
        this.isLoadingAppItem = false;
    ...
    loadInitialState() {
        ...
        const designId = (designIdInput === null || designIdInput === void 0 ? void 0 : designIdInput.value.trim()) || null;
        if (designId) {
            this.currentAppItemId = designId;
            console.log(`Found AppItem ID: ${this.currentAppItemId}. Loading data...`);
            this.loadAppItemData(this.currentAppItemId);
        }
        else {
            console.error("AppItem ID input element not found or has no value. Cannot load document.");
            (_a = this.toastManager) === null || _a === void 0 ? void 0 : _a.showToast("Error", "Could not load document: AppItem ID missing.", "error");
        }
    }
    loadAppItemData(designId) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(`AppItemDetailsPage: Loading design ${designId}...`);
        });
    }
...
document.addEventListener('DOMContentLoaded', () => {
    const lc = new AppItemDetailsPage();
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = this["webpackChunkapptemplate"] = this["webpackChunkapptemplate"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["frontend_components_Modal_ts-frontend_components_ThemeManager_ts-frontend_components_ToastMan-fef01a"], () => (__webpack_require__("./frontend/components/AppItemDetailsPage.ts")))
...
//# sourceMappingURL=AppItemDetailsPage.af838c7d3cfcc7cb606c.js.map