// ./web/views/components/AppItemDetailsPage.ts
...
class AppItemDetailsPage {
    ...
    private currentAppItemId: string | null = null;
    private isLoadingAppItem: boolean = false; // Loading state
    ...
    private loadInitialState(): void {
        ...
        if (designId) {
            ...
            this.toastManager?.showToast("Error", "Could not load document: AppItem ID missing.", "error");
        }
    }
     ...
     */
    private async loadAppItemData(designId: string): Promise<void> {
