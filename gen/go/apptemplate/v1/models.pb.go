...
func (x *Pagination) Reset() {
	*x = Pagination{}
	mi := &file_apptemplate_v1_models_proto_msgTypes[0]
...
func (*Pagination) Descriptor() ([]byte, []int) {
	return file_apptemplate_v1_models_proto_rawDescGZIP(), []int{0}
}
...
func (x *PaginationResponse) Reset() {
	*x = PaginationResponse{}
	mi := &file_apptemplate_v1_models_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PaginationResponse) Descriptor() ([]byte, []int) {
	return file_apptemplate_v1_models_proto_rawDescGZIP(), []int{1}
}
...
func (x *AppItem) Reset() {
	*x = AppItem{}
	mi := &file_apptemplate_v1_models_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppItem) Descriptor() ([]byte, []int) {
	return file_apptemplate_v1_models_proto_rawDescGZIP(), []int{2}
}

func (x *AppItem) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *AppItem) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
const file_apptemplate_v1_models_proto_rawDesc = "" +
	"\n" +
	"\x1bapptemplate/v1/models.proto\x12\x0eapptemplate.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"e\n" +
	"\n" +
	"Pagination\x12\x19\n" +
...
var (
	file_apptemplate_v1_models_proto_rawDescOnce sync.Once
	file_apptemplate_v1_models_proto_rawDescData []byte
)

func file_apptemplate_v1_models_proto_rawDescGZIP() []byte {
	file_apptemplate_v1_models_proto_rawDescOnce.Do(func() {
		file_apptemplate_v1_models_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_apptemplate_v1_models_proto_rawDesc), len(file_apptemplate_v1_models_proto_rawDesc)))
	})
	return file_apptemplate_v1_models_proto_rawDescData
}

var file_apptemplate_v1_models_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_apptemplate_v1_models_proto_goTypes = []any{
	(*Pagination)(nil),            // 0: apptemplate.v1.Pagination
	(*PaginationResponse)(nil),    // 1: apptemplate.v1.PaginationResponse
	(*AppItem)(nil),               // 2: apptemplate.v1.AppItem
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_apptemplate_v1_models_proto_depIdxs = []int32{
	3, // 0: apptemplate.v1.AppItem.created_at:type_name -> google.protobuf.Timestamp
	3, // 1: apptemplate.v1.AppItem.updated_at:type_name -> google.protobuf.Timestamp
...
func init() { file_apptemplate_v1_models_proto_init() }
func file_apptemplate_v1_models_proto_init() {
	if File_apptemplate_v1_models_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_apptemplate_v1_models_proto_rawDesc), len(file_apptemplate_v1_models_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_apptemplate_v1_models_proto_goTypes,
		DependencyIndexes: file_apptemplate_v1_models_proto_depIdxs,
		MessageInfos:      file_apptemplate_v1_models_proto_msgTypes,
	}.Build()
	File_apptemplate_v1_models_proto = out.File
	file_apptemplate_v1_models_proto_goTypes = nil
	file_apptemplate_v1_models_proto_depIdxs = nil
}
